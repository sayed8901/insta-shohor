...
const displayContent = (text) => {
  /* Post এর Description  30 Character এর বেশী হলে  Read More দেখাতে
  hard-coded 'text' এর বদলে dynamically ফাংশনের parameter থেকে পাওয়া text-কে ব্যবহার করতে হবে */
              ...
              <div class="post__header">
                <div class="post__profile">
                  <a
                    ...
                    class="post__avatar"
                  >
                  /* User  এর  Profile Photo ও Name দেখাতে */
...
const displayLikedPosts = () => {
    ...
    /* প্রতিবার React Posts এ যাওয়ার পরে পোষ্ট Double হয়ে যাচ্ছে এটা ঠিক করতে */
...
const displayReportedPosts = () => {
    ...
    /* Reported Post এ সবগুলো পোষ্ট দেখাচ্ছে এই সমস্যার সমাধান করতে..
    এজন্যে, post এর উপরে forEach হবে না হবে, reportedPost এর উপরে */


    /* প্রতিবার Reported Posts এ যাওয়ার পরে পোষ্ট Double হয়ে যাচ্ছে এটা ঠিক করতে */
